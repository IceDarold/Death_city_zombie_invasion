...
namespace RootMotion
{
    public static class BipedNaming
    {
        ...
        public static Transform[] GetBonesOfType(BoneType boneType, Transform[] bones)
        {
            ...
            {
                if ((UnityEngine.Object)transform != (UnityEngine.Object)null && BipedNaming.GetBoneType(transform.name) == boneType)
                {
        ...
        public static Transform[] GetBonesOfSide(BoneSide boneSide, Transform[] bones)
        {
            ...
            foreach (Transform transform in bones)
            {
                if ((UnityEngine.Object)transform != (UnityEngine.Object)null && BipedNaming.GetBoneSide(transform.name) == boneSide)
                {
                    Array.Resize(ref array, array.Length + 1);
                    array[array.Length - 1] = transform;
                }
