...
namespace RootMotion.FinalIK
{
    ...
    public class AimIK : IK
    {
        ...
        public void SetPreUpdate(IKSolver.UpdateDelegate action)
        {
            this.solver.OnPreUpdate = action;
        }

        public void SetPostUpdate(IKSolver.UpdateDelegate action)
        {
            this.solver.OnPostUpdate = action;
        }
