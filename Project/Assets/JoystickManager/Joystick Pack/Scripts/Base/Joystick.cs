...
public class Joystick : Singleton<Joystick>, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    protected LayerMask worldUILayer;
    ...
    public Vector2 StartInput { get; private set; }
    ...
    {
        StartInput = eventData.pointerCurrentRaycast.screenPosition;
        onStartInput?.Invoke();
    }
    ...
    public void SetWorldUILayer(LayerMask layer)
    {
        worldUILayer = layer;
    }
}
